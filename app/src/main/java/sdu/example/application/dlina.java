...
public class dlina extends AppCompatActivity {
    TextView num;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dlina);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.result:
                try {
                    num.setText(Integer.parseInt(num.getText().toString()) * 100f + "");
                } catch (NumberFormatException ex) {
                    num.setText(Float.parseFloat(num.getText().toString()) * 100.0f + "");
                }
                break;
            case R.id.clearr:
