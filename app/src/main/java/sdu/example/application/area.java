...
public class area extends AppCompatActivity {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.result:
                try {
                    num.setText(Integer.parseInt(num.getText().toString()) * 10000f + "");
                } catch (NumberFormatException ex) {
                    num.setText(Float.parseFloat(num.getText().toString()) * 10000.0f + "");
                }
                break;
            case R.id.clearr:
            ...
            case R.id.reverse:
                try {
                    num.setText(Integer.parseInt(num.getText().toString()) / 10000.0f + "");
                } catch (NumberFormatException ex) {
                    num.setText(Float.parseFloat(num.getText().toString()) * 10000.0f + "");
                }
                break;
